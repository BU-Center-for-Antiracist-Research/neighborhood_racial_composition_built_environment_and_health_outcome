...
# Load data 
# df <- readRDS(file = "../Replication/FinalData/finaldata.rds")
...
df_prop_dilapbldg <- df_composition %>%
  dplyr::select(prop_dilapbldg, Composition, Median.household.income, Pct_college , Age, Pct_Female , Pct_insurance , Pct_Owner , Pct_Vacant , Pct_SingleFam) %>%
  na.omit()

mod_na_fe1 <- lm(prop_dilapbldg ~ Composition,
                   data = df_prop_dilapbldg, REML=FALSE)

mod_na_cov_fe1 <- lm(prop_dilapbldg ~ Composition + log(Median.household.income) + Pct_college + Age + Pct_Female + Pct_insurance + Pct_Owner + Pct_Vacant + Pct_SingleFam,
                       data = df_prop_dilapbldg, REML=FALSE)
```
...
df_prop_green <- df_composition %>%
  dplyr::select(prop_green, Composition, Median.household.income, Pct_college , Age, Pct_Female , Pct_insurance , Pct_Owner , Pct_Vacant , Pct_SingleFam ) %>%
  na.omit()

mod_na_fe2 <- lm(prop_green ~ Composition ,
                   data = df_prop_green, REML=FALSE)

mod_na_cov_fe2 <- lm(prop_green ~ Composition + log(Median.household.income) + Pct_college + Age + Pct_Female + Pct_insurance + Pct_Owner + Pct_Vacant + Pct_SingleFam ,
                       data = df_prop_green, REML=FALSE)
```
...
df_prop_crosswalk <- df_composition %>%
  dplyr::select(prop_crosswalk, Composition, Median.household.income, Pct_college , Age, Pct_Female , Pct_insurance , Pct_Owner , Pct_Vacant , Pct_SingleFam) %>%
  na.omit()

mod_na_fe3 <- lm(prop_crosswalk ~ Composition ,
                   data = df_prop_crosswalk, REML=FALSE)

mod_na_cov_fe3 <- lm(prop_crosswalk ~ Composition + log(Median.household.income) + Pct_college + Age + Pct_Female + Pct_insurance + Pct_Owner + Pct_Vacant + Pct_SingleFam ,
                       data = df_prop_crosswalk, REML=FALSE)
```
...
df_prop_not_single_family_home <- df_composition %>%
  dplyr::select(prop_not_single_family_home, Composition, Median.household.income, Pct_college , Age, Pct_Female , Pct_insurance , Pct_Owner , Pct_Vacant , Pct_SingleFam) %>%
  na.omit()

mod_na_fe4 <- lm(prop_not_single_family_home ~ Composition ,
                   data = df_prop_not_single_family_home, REML=FALSE)

mod_na_cov_fe4 <- lm(prop_not_single_family_home ~ Composition + log(Median.household.income) + Pct_college + Age + Pct_Female + Pct_insurance + Pct_Owner + Pct_Vacant ,
                       data = df_prop_not_single_family_home, REML=FALSE)
```
...
df_prop_single_lane <- df_composition %>%
  dplyr::select(prop_single_lane, Composition, Median.household.income, Pct_college , Age, Pct_Female , Pct_insurance , Pct_Owner , Pct_Vacant , Pct_SingleFam) %>%
  na.omit()

mod_na_fe5 <- lm(prop_single_lane ~ Composition ,
                   data = df_prop_single_lane, REML=FALSE)

mod_na_cov_fe5 <- lm(prop_single_lane ~Composition + log(Median.household.income) + Pct_college + Age + Pct_Female + Pct_insurance + Pct_Owner + Pct_Vacant + Pct_SingleFam,
                       data = df_prop_single_lane, REML=FALSE)
```
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_OLS_no_cutoff.html"
)
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_OLS_10_cutoff.html"
)
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_OLS_20_cutoff.html"
)

...
lmer_topo_mediatin_unadjusted=function(treatment_var, med_var, outcome_var, REML=TRUE){
...
for (health in health_cols){
  for (be in be_cols){
        capture.output(paste(health,'mediated by',be), file = paste0('../Output/lmer_urban_unadjusted/',health,'~',be,'.txt'),append=TRUE)
    
    
    capture.output(lmer_topo_mediatin_unadjusted('Composition', be,health, FALSE), file = paste0('../Output/lmer_urban_unadjusted/',health,'~',be,'.txt'),append=TRUE)
    
    
      capture.output('=======================', file = paste0('../Output/lmer_urban_unadjusted/',health,'~',be,'.txt'),append=TRUE)
...
for (health in health_cols){
  for (be in be_cols){
        capture.output(paste(health,'mediated by',be), file = paste0('../Output/lmer_urban/',health,'~',be,'.txt'),append=TRUE)
    
    
    capture.output(lmer_topo_mediatin('Composition', be,health, FALSE), file = paste0('../Output/lmer_urban/',health,'~',be,'.txt'),append=TRUE)
    
    
      capture.output('=======================', file = paste0('../Output/lmer_urban/',health,'~',be,'.txt'),append=TRUE)

...
tab_model(mod_na_fe1, 
  ...
  ,
  file = "../Output/Table2_Null_Models.html"
)
...
tab_model(mod_na_cov_fe1, 
  ...
  ,
  file = "../Output/Supplementary/TableF1.html"
)
...
tab_model(mod_na_fe1, 
  ...
  ,
  file = "../Output/Supplementary/TableF1_Null.html"
)
```

#### Section F.3. 10% cut-off
...
tab_model(mod_na_cov_fe1, 
  ...
  ,
  file = "../Output/Supplementary/TableF3.html"
)
...
### Sensitivity Analysis (Continued with State and County intercepts)
...
summary(mod_na_cov_fe1)

print(ranef(mod_na_cov_fe1))
print(ranova(mod_na_cov_fe1))
print(confint(mod_na_cov_fe1))

df_prop_dilapbldg %>% group_by(State) %>% summarise(n=n()) %>% summary()
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_state_no_cutoff.html"
)
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_state_10_cutoff.html"
)
...
# lm_test=lm(prop_dilapbldg ~ Composition + log(Median.household.income) + Pct_college + Age + Pct_Female + Pct_insurance + Pct_Owner + Pct_Vacant + Pct_SingleFam, data=df_prop_dilapbldg)
# anova(lm_test,
#       mod_na_cov_fe1)
# 
# anova(
#       mod_na_cov_fe1, lm_test)
```
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Replication/Output/Table2_state_20_cutoff.html"
)
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_statecounty_no_cutoff.html"
)
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_statecounty_10_cutoff.html"
)
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_statecounty_20_cutoff.html"
)
...
df_prop_dilapbldg %>% group_by(countyfips) %>% summarise(n=n()) %>% summary()

df_prop_dilapbldg %>% group_by(countyfips) %>% summarise(n=n()) %>% mutate(pct=round(n/sum(n)*100,3)) 
```
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_county_no_cutoff.html"
)
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_county_10_cutoff.html"
)
...
tab_model(mod_na_fe1, mod_na_cov_fe1, 
  ...
  file = "../Output/Table2_statecounty_order_no_cutoff.html"
)

...
# Load data 
mediation <- read_excel("/Users/ahyoungcho/Dropbox/CAR/2022 Summer/Replication/Output/Mediation.xlsx")
```
...
jpeg(file = "/Users/ahyoungcho/Dropbox/CAR/2022 Summer/Replication/Output/Figure5.jpeg", width = 15, height = 10, res = 300, units = 'in')
figure
dev.off()


jpeg(file = "/Users/ahyoungcho/Dropbox/CAR/2022 Summer/Replication/Output/Figure5a.jpeg", width = 8.5, height =11, res = 300, units = 'in')
figurea
dev.off()


jpeg(file = "/Users/ahyoungcho/Dropbox/CAR/2022 Summer/Replication/Output/Figure5b.jpeg", width = 8.5, height =11, res = 300, units = 'in')
figureb
dev.off()
```
